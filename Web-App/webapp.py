...
data_bunch = ImageDataBunch.single_from_classes("E:\my programs\SGP\sem4\App",classes,ds_tfms=get_transforms(), size=150).normalize(imagenet_stats)
...
def prediction(filename):
   ...
   # x = 
    ...
    predictions={"class0":str(x[0]),
                 
                 "prob0":[str(x[0]),cat[temp]]
    }
